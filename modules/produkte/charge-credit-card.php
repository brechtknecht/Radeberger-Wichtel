<?php
  ...
  $merchantAuthentication->setName("4tm4AW27");
  $merchantAuthentication->setTransactionKey("3548P4TpSyFru52U");
  $refId = 'ref' . time();

  // Create the payment data for a credit card
  $creditCard = new AnetAPI\CreditCardType();
  $creditCard->setCardNumber($_SESSION['page_user']['CC_number']);
  $creditCard->setExpirationDate($_SESSION['page_user']['CC_exp']);
