...
************************************************************************************************************/	
	...
	//own
	var color_picker_change_color = false;
	...
	function chooseColor()
	{
		...
		color_picker_div.style.display='none';
		if(color_picker_change_color){
			color_picker_change_color.style.backgroundColor = color_picker_form_field.value;	
		}
	...
	function showColorPicker(inputObj,formField,changeColor)
	{
		if(!color_picker_div){
		...
		color_picker_change_color = changeColor;
	}
