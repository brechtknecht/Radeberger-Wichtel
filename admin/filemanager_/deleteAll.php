...
if(isset($_POST['entry_parent_id'], $_POST['file_cat1'], $_POST['file_cat2'])){
    ...
    $query = ("SELECT entry_id, file_save_name FROM _cms_hp_files_ WHERE file_cat1='".mysqli_real_escape_string($_SESSION['conn'], $_POST['file_cat1'])."' AND file_cat2='".mysqli_real_escape_string($_SESSION['conn'], $_POST['file_cat2'])."' AND entry_parent_id=".$_POST['entry_parent_id']);
